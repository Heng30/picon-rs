...
#define PRODUCT_NAME           "picon" // 产品名称
...
#define INTERNAL_NAME          "picon.exe"
#define FILE_DESCRIPTION       "picon can display crypto trend"  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "picon.exe"    // 原始文件名
